...
allied_images_level1 = [pg.image.load(f'invocations/sprite_russo1_{i}.png').convert_alpha() for i in range(3)]
allied_images_level2 = [pg.image.load(f'invocations/sprite_russo2_{i}.png').convert_alpha() for i in range(3)]
allied_images_level3 = [pg.image.load(f'invocations/sprite_russo3_{i}.png').convert_alpha() for i in range(3)]
allied_images_level4 = [pg.image.load(f'invocations/sprite_russo4_{i}.png').convert_alpha() for i in range(3)]
